...
export PATH="$HOME/Dropbox/Sites/_TOOLS/scripts/WordPress-Builder:$HOME/Dropbox/Sites/__TOOLS/scripts:/usr/local/bin:/usr/local:/usr/bin:/usr/local/sbin:/bin:/usr/sbin:/sbin"
